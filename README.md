# Lilian Omoike â€” Cybersecurity Portfolio
...
**Repo:** [AWS Integrated GRC Platform â†’](https://github.com/Omoike-lilian/aws-grc-platform)

---

## ðŸ›¡ï¸ Risk & Governance Projects

| Project | Focus | Tools/Frameworks | Summary |
|---|---|---|---|
| **SecureBank Quantitative Risk Analysis** | Quantitative Risk (SLE, ARO, ALE, ROI) | Excel, NIST CSF, CIS Controls | Calculated financial risk exposure and ROI for mitigation controls |
| **TechStart Risk Assessment** | GRC Case Study | ISO 31000, NIST CSF | Evaluated 10 risks and proposed mitigations for a fintech organization |
| **TechFlow Assessment** | Business Risk Evaluation | NIST 800-30 | Performed risk rating and mitigation plan for cloud-based systems |

## ðŸ” Vulnerability & Threat Analysis

| Project | Focus | Tools | Summary |
|---|---|---|---|
| **Metasploitable Assessment** | Host Vulnerability Scanning | Nmap, Nuclei, Nikto | Identified critical CVEs, mapped to CIS and NIST, and produced a mitigation plan |
| **Critical OWASP Top 10 Analysis** | Web Application Security | Burp Suite, OWASP | Mapped vulnerabilities to the OWASP Top 10 with remediation recommendations |

## ðŸ–¥ï¸ SOC & Incident Response Projects

| Project | Focus | Tools | Summary |
|---|---|---|---|
| **Log Analysis Report** | SIEM & Threat Detection | Splunk | Analyzed system logs and identified anomalies related to CVEs and attack patterns |
| **Wazuh SIEM Deployment & Analysis** | Security Monitoring, FIM & Compliance | Wazuh, Ubuntu Server, Windows 11, MobaXterm | End-to-end deployment and analysis of a Wazuh SIEM in a simulated enterprise environment, covering file integrity monitoring, vulnerability detection, CIS Benchmark configuration assessment, and compliance mapping |

**Wazuh SIEM Deployment â€” additional detail:**
